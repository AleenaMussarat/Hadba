...
export interface ApiCarouselSlideCarouselSlide
  ...
  info: {
    description: 'A hero carousel slide on the homepage, English and Arabic together on one entry (max 5 active)';
  ...
  attributes: {
    badgeAr: Schema.Attribute.String;
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A reservation inquiry submitted from the website's Inquiries form";
    displayName: 'Inquiry';
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A single dish on the menu, English and Arabic together on one entry';
  ...
  attributes: {
    ...
    categoryAr: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiStaffAccountStaffAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'staff_accounts';
  info: {
    description: 'Create a new admin login here \u2014 saving creates the real account immediately with the password you set, no email required';
    displayName: 'Staff Account';
    pluralName: 'staff-accounts';
    singularName: 'staff-account';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::staff-account.staff-account'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
