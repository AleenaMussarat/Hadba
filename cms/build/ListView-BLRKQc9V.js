import{j as e,h as x,S as p,fa as L,a as F,v as b,A as $,F as Ce,r as R,aR as E,d as U,q as Te,ab as we,fN as ve,c6 as Q,a8 as ee,bg as Z,fO as ke,n as te,bT as $e,bl as De,bn as Me,d2 as Re,bC as Se,aP as Ae,K as Fe,bY as ne,I as P,ct as Ie,a0 as Oe,D as Ee,fu as Le,bG as Ne,aY as V,fP as Ue,L as oe}from"./strapi-3QTgdIkI.js";import{u as D,g as m,C as _,a as H,A as Pe,S as Be,c as X,b as ie}from"./index-DmszJhIL.js";import{l as ze,m as J,n as Ve,P as We,D as Ze,o as He,k as qe,C as Ge}from"./core.esm-0hv7UzMf.js";import{s as Ke,S as Ye,v as _e,u as Xe}from"./sortable.esm-i6-U_iWP.js";import"./index-DhsX8fvK.js";import"./groupBy-Cz8GGGUZ.js";import"./_baseEach-D9kt2VCa.js";import"./sortBy-Dm-geTmG.js";import"./_baseMap-CWlYr6Tc.js";import"./index-BcRe8s2m.js";import"./index-BRVyLNfZ.js";const Je=t=>{let{transform:n}=t;return{...n,x:0}},Qe=x(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,mt=({uid:t})=>{const{components:n}=D(),o=L(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(Q,{onClick:s=>s.stopPropagation(),tag:ee,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:Z(o.info.displayName)}),")"]})},de=x(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
...
`,Tt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=F(),s=Oe(),a=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Ee(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Le,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),wt=x(oe.Header)`
  ...
  white-space: nowrap;
`,Et=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:a}=F(),{trackUsage:l}=ie(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:k}=H(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(V,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type"})}if(i&&r.modelType==="contentType"&&r.visible===!1)return e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type",replace:!0});const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",T=r?.info?.displayName??"",w=t&&!d,S=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},M=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}k({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),A=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(b,{gap:2,children:[e.jsx(Tt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(P,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:M,disabled:!w||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(P,{startIcon:e.jsx(E,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:A})]});return e.jsxs(e.Fragment,{children:[e.jsx(ne.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(b,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(b,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx($,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(wt,{id:"title",primaryAction:h,title:Z(T)}),e.jsx(oe.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:S,isMain:!0})})})]})};export{Et as default};
