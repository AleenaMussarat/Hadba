...
export const translations = {
  en: {
    ...
    reserve: {
      ...
      submit: 'Send Inquiry',
      submitting: 'Sending…',
      closedTitle: 'Reservations Currently Unavailable',
      closedMessage: "SAMDAN is fully booked for today and unable to accept further reservations at this time. We warmly invite you to try again tomorrow, or call us directly and our team will be glad to assist.",
      callPhone: 'Please call us directly at:',
      todayOnly: 'Reservations are available for today only: {date}',
      selectTime: 'Select a time',
      dateError: 'Reservations can only be made for today', errorText: "Something went wrong sending your request — please try again, or call us at +966 55 518 5657 | +966 53 334 7721.",
  ...
  ar: {
    ...
    hero: {
      ...
      hoursValue: 'مفتوح 24 ساعة يومياً',
    ...
    story: {
      ...
      description: 'في قلب الرياض، يقدّم سمدان تجربة متخصصة في الحنيذ، مستوحاة من أصالة المطبخ الجنوبي وتراثه العريق.\nنختار أجود المكونات، ونعتني بطريقة التحضير والتقديم، لنقدّم حنيذًا بطعم أصيل وتجربة تليق بضيوفنا',
      chefTitle: 'مطبخنا',
    ...
    reserve: {
      ...
      closedTitle: 'الحجوزات غير متاحة حالياً',
      closedMessage: 'وصل سمدان إلى كامل طاقته الاستيعابية لهذا اليوم، ولا يمكننا استقبال حجوزات إضافية في الوقت الحالي. يسعدنا استقبالكم غدًا، أو يمكنكم التواصل معنا مباشرة وسيكون فريقنا سعيدًا بمساعدتكم.',
      callPhone: 'يرجى الاتصال بنا مباشرة على:',
      todayOnly: 'الحجوزات متاحة لليوم فقط: {date}',
      selectTime: 'اختر الوقت',
      dateError: 'الحجوزات متاحة لليوم فقط', errorText: 'حدث خطأ أثناء إرسال طلبكم — يرجى المحاولة مرة أخرى، أو الاتصال بنا على +966 55 518 5657 | +966 53 334 7721.',
